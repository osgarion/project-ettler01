...
res_surv_ttnt$surv[[6]]$`CoxPH plot full`
```

```{r stat_2_surv_cox_forest_bmi}
res_surv_ttnt$surv[[6]]$`CoxPH forest plot full`
```
...
res_surv_ttnt$surv[[7]]$`CoxPH plot full`
```

```{r stat_2_surv_cox_forest_age}
res_surv_ttnt$surv[[7]]$`CoxPH forest plot full`
```
