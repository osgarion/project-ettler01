...
res_surv_response$surv[[6]]$`CoxPH plot quantile`
```

```{r stat_2_surv_response_cox_forest_bmi}
res_surv_response$surv[[6]]$`CoxPH forest plot qunatile`
```
...
res_surv_response$surv[[7]]$`CoxPH plot quantile`
```

```{r stat_2_surv_response_cox_forest_age}
res_surv_response$surv[[7]]$`CoxPH forest plot qunatile`
```
